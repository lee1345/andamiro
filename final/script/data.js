...
const  Narmi= [ 
    ...
    이번에 보육원 아이들에게 악기를 사주고, 직접 가르쳐주고 싶은 마음이 생겼습니다.

    음악은 아이들에게 큰 힘이 되고, 감정을 표현하는 소중한 방법입니다. 
    제가 가르치는 바이올린을 통해 아이들이 새로운 꿈과 희망을 발견할 수 있도록 돕고 싶습니다. 
    하지만 이를 실현하기 위해서는 여러분의 도움이 필요합니다.
    악기 구매와 교육에 필요한 자금을 모으고자 합니다. 
    함께 아이들에게 음악의 즐거움을 선물해주실 수 있도록 도와주세요!
    ...
    IT에 대한 열정이 큰 만큼, 이번에는 보육원 아이들에게 IT기기를 선물하고 싶습니다.
    아이들이 미래의 IT 인재로 성장할 수 있도록, 지식도 전달해보고 싶습니다. 

    많은 참여 부탁드립니다.
    즐거운 수업 만들어보겠습니다!`},
    
    //최민영
    {id: 3, N_region: "천안시", N_city: "서북구", N_location: "사랑의 노인 복지센터", N_location_img: "../../img/narmi/narmi3.png", agent_name: "최민영", agent_img: "../../img/narmi/agent3.png", N_Target_amount: 1500000, N_funding_achievement: 150000, D_day: "45", End_date: "2025-01-01", N_funding_progress: 10, N_head_count: 30,ct:1,
    agent_Introduce:
    `    안녕하세요, 저는 최민영입니다.
    매일 지겹도록 반복되는 삶속에서 새로운 변화를 찾고 싶다는 마음이 커졌습니다. 
    저는 노인 복지센터에서 어르신들께 도움을 드리고 싶습니다. 

    우리의 노인 분들은 많은 경험과 지혜를 가지고 계십니다. 
    그러나 종종 외로움과 소외감을 느끼실 때가 많습니다. 
    저는 이 분들과의 소통을 통해 그들에게 따뜻한 관심과 사랑을 전하고, 
    소중한 시간을 함께 나누고 싶습니다. 
    
    이 활동을 위해 필요한 물품과 프로그램 운영 비용이 필요합니다. 
    저와 함께 어르신들에게 새로움을 찾아주세요!`},
    
    //김학철
    {id: 4, N_region: "아산시", N_city: "탕정면", N_location: "탕정도서관", N_location_img: "../../img/narmi/narmi4.png", agent_name: "김학철", agent_img: "../../img/narmi/agent4.png", N_Target_amount: 2000000, N_funding_achievement: 400000, D_day: "30", End_date: "2024-12-01", N_funding_progress: 20, N_head_count: 2,ct:2,
    agent_Introduce:
    `    안녕하세요! 저는 65세 김학철입니다. 
    작가로서의 삶을 마무리한 후, 아이들에게 도서를 선물하고 글쓰기 재능을 나누고 싶습니다. 
    아이들이 다양한 책을 접하고, 글쓰기의 즐거움을 느낄 수 있도록 도와주고 싶습니다. 
    책은 상상력을 키워주고, 자신을 표현하는 방법을 배우는 중요한 도구입니다. 
    
    제가 가진 경험과 노하우를 통해 아이들에게 글쓰기의 기초를 가르치고 싶습니다. 
    한국에 차기 노벨 문학상을 위해 많은 관심과 후원 부탁드립니다. 감사합니다.`},   
    
    //한민숙
    {id: 5, N_region: "아산시", N_city: "배방읍", N_location: "배방읍 어린이 지원 센터", N_location_img: "../../img/narmi/narmi5.png", agent_name: "한민숙", agent_img: "../../img/narmi/agent5.png", N_Target_amount: 1500000, N_funding_achievement: 300000, D_day: "30", End_date: "2024-12-01", N_funding_progress: 20, N_head_count: 5,ct:2,
    agent_Introduce:
    `    안녕하세요! 저는 57세 한민숙입니다.
    일찍 결혼해 세 남매를 이른 나이에 키우고 모두 시집 장가보내니 허전하더군요
    좋은기회를 발견하여 아이 셋을 키웠던 경험으로 봉사활동을 해보고 싶어졌습니다.

    특히, 지원이 부족한 보육원에 아이들을 키우는 데 필요한 생필품을 지원하고 싶습니다. 
    아이들이 건강하게 성장할 수 있도록 도와줄 수 있는 기회를 찾고 있습니다. 
    ...
    내 Hamberger, Hotdog recipe 맛있어요 아이들 좋아해요! 🍔🌭 
    하지만 이 멋진 계획 재료 필요해요. 
...
const campaign = [
    ...
    
    {
      ...
      
      {
        ...
        W_Participant_Count: 45,
        W_Participation_Rate: 45,
        W_D_day: "8",
        W_End_date: "2024-10-28",
